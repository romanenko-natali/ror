...
class TaskItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_item" do
    assert_difference("TaskItem.count") do
      post task_items_url, params: { task_item: { body: @task_item.body, published: @task_item.published, title: @task_item.title } }
    end
  ...
  test "should update task_item" do
    patch task_item_url(@task_item), params: { task_item: { body: @task_item.body, published: @task_item.published, title: @task_item.title } }
